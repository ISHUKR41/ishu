// ============================================================================
// FILE: modules/Results/States/himachal-pradesh/backend/index.ts
// PURPOSE: Isolated backend API for Himachal Pradesh (HP) state results.
//          Queries the REAL SQLite database using Drizzle ORM.
//          Filters results where state = "Himachal Pradesh".
//
...
export const stateConfig = {
  ...
  description: "Get the latest Himachal Pradesh government exam results, notifications, and updates for all state-level examinations.",
  ...
  apiEndpoint: "/api/results?state=Himachal Pradesh&limit=50",
} as const;
