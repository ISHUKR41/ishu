// ============================================================================
// FILE: modules/Results/States/haryana/backend/index.ts
// PURPOSE: Isolated backend API for Haryana (HR) state results.
//          Queries the REAL SQLite database using Drizzle ORM.
//          Filters results where state = "Haryana".
//
...
export const stateConfig = {
  ...
  description: "Get the latest Haryana government exam results, notifications, and updates for all state-level examinations.",
  ...
  apiEndpoint: "/api/results?state=Haryana&limit=50",
} as const;
