// ============================================================================
// FILE: modules/Results/States/lakshadweep/backend/index.ts
// PURPOSE: Isolated backend API for Lakshadweep (LD) state results.
//          Queries the REAL SQLite database using Drizzle ORM.
//          Filters results where state = "Lakshadweep".
//
...
export const stateConfig = {
  ...
  description: "Get the latest Lakshadweep government exam results, notifications, and updates for all state-level examinations.",
  ...
  apiEndpoint: "/api/results?state=Lakshadweep&limit=50",
} as const;
