// ============================================================================
// FILE: modules/Results/States/delhi/backend/index.ts
// PURPOSE: Isolated backend API for Delhi (DL) state results.
//          Queries the REAL SQLite database using Drizzle ORM.
//          Filters results where state = "Delhi".
//
...
export const stateConfig = {
  ...
  description: "Get the latest Delhi government exam results, notifications, and updates for all state-level examinations.",
  keywords: "Delhi results, Delhi exam results, Delhi government jobs, DL results",
  canonical: "https://ishu.in/results/states/delhi",
  apiEndpoint: "/api/results?state=Delhi&limit=50",
} as const;
