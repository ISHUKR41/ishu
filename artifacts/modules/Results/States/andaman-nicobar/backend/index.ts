// ============================================================================
// FILE: modules/Results/States/andaman-nicobar/backend/index.ts
// PURPOSE: Isolated backend API for Andaman & Nicobar (AN) state results.
//          Queries the REAL SQLite database using Drizzle ORM.
//          Filters results where state = "Andaman & Nicobar".
//
...
export const stateConfig = {
  ...
  description: "Get the latest Andaman & Nicobar government exam results, notifications, and updates for all state-level examinations.",
  ...
  apiEndpoint: "/api/results?state=Andaman & Nicobar&limit=50",
} as const;
