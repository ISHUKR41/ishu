// ============================================================================
// FILE: modules/Results/States/andaman-nicobar/frontend/index.tsx
// PURPOSE: Isolated frontend for Andaman & Nicobar (AN) state results.
...
/**
 * Andaman & NicobarResultsPage — The dedicated page for Andaman & Nicobar exam results.
 *
 * WHAT IT DOES:
 * 1. Fetches results filtered by state="Andaman & Nicobar" from the backend API.
 ...
 */
export default function AndamannicobarResultsPage() {
  ...
  const { data, isLoading, error } = useQuery<{ results: StateResult[]; total: number }>({
    queryKey: ["results", "state", "andaman-nicobar"],
    queryFn: async () => {
      const res = await fetch("/api/results?state=Andaman & Nicobar&limit=50");
      if (!res.ok) throw new Error("Failed to fetch Andaman & Nicobar results");
      return res.json();
    },
  ...
  return (
    <>
      ...
      <PageMeta
        title={`Andaman & Nicobar Exam Results - Latest Updates | Ishu`}
        description={`Get the latest Andaman & Nicobar government exam results, notifications, and updates. Stay informed about all state-level examinations.`}
        keywords="Andaman & Nicobar results, Andaman & Nicobar exam results, Andaman & Nicobar government jobs, AN results"
      />
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-bold text-foreground">
                  Andaman & Nicobar Results
                </h1>
                <p className="text-muted-foreground text-sm">
                  State Code: AN • All government exam results
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6 py-10">
          ...
          {isLoading && (
            <div className="flex justify-center items-center py-20">
              ...
              <span className="ml-3 text-muted-foreground">Loading Andaman & Nicobar results...</span>
            </div>
          )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {data.results.length > 0 ? (
                ...
                <div className="col-span-full text-center py-16 border border-dashed border-border rounded-2xl">
                  ...
                  <p className="text-muted-foreground">No results found for Andaman & Nicobar yet.</p>
