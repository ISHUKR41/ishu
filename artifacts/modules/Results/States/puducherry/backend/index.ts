// ============================================================================
// FILE: modules/Results/States/puducherry/backend/index.ts
// PURPOSE: Isolated backend API for Puducherry (PY) state results.
//          Queries the REAL SQLite database using Drizzle ORM.
//          Filters results where state = "Puducherry".
//
...
export const stateConfig = {
  ...
  description: "Get the latest Puducherry government exam results, notifications, and updates for all state-level examinations.",
  ...
  apiEndpoint: "/api/results?state=Puducherry&limit=50",
} as const;
