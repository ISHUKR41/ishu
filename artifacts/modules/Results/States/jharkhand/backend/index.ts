// ============================================================================
// FILE: modules/Results/States/jharkhand/backend/index.ts
// PURPOSE: Isolated backend API for Jharkhand (JH) state results.
//          Queries the REAL SQLite database using Drizzle ORM.
//          Filters results where state = "Jharkhand".
//
...
export const stateConfig = {
  ...
  description: "Get the latest Jharkhand government exam results, notifications, and updates for all state-level examinations.",
  ...
  apiEndpoint: "/api/results?state=Jharkhand&limit=50",
} as const;
