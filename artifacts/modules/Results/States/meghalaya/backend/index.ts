// ============================================================================
// FILE: modules/Results/States/meghalaya/backend/index.ts
// PURPOSE: Isolated backend API for Meghalaya (ML) state results.
//          Queries the REAL SQLite database using Drizzle ORM.
//          Filters results where state = "Meghalaya".
//
...
export const stateConfig = {
  ...
  description: "Get the latest Meghalaya government exam results, notifications, and updates for all state-level examinations.",
  ...
  apiEndpoint: "/api/results?state=Meghalaya&limit=50",
} as const;
