// ============================================================================
// FILE: modules/Results/States/meghalaya/frontend/index.tsx
// PURPOSE: Isolated frontend for Meghalaya (ML) state results.
...
/**
 * MeghalayaResultsPage — The dedicated page for Meghalaya exam results.
 *
 * WHAT IT DOES:
 * 1. Fetches results filtered by state="Meghalaya" from the backend API.
...
export default function MeghalayaResultsPage() {
  ...
  const { data, isLoading, error } = useQuery<{ results: StateResult[]; total: number }>({
    queryKey: ["results", "state", "meghalaya"],
    queryFn: async () => {
      const res = await fetch("/api/results?state=Meghalaya&limit=50");
      if (!res.ok) throw new Error("Failed to fetch Meghalaya results");
      return res.json();
    },
  ...
  return (
    <>
      ...
      <PageMeta
        ...
        description={`Get the latest Meghalaya government exam results, notifications, and updates. Stay informed about all state-level examinations.`}
        keywords="Meghalaya results, Meghalaya exam results, Meghalaya government jobs, ML results"
      />
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  State Code: ML • All government exam results
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6 py-10">
          ...
          {isLoading && (
            <div className="flex justify-center items-center py-20">
              ...
              <span className="ml-3 text-muted-foreground">Loading Meghalaya results...</span>
            </div>
          )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {data.results.length > 0 ? (
                ...
                <div className="col-span-full text-center py-16 border border-dashed border-border rounded-2xl">
                  ...
                  <p className="text-muted-foreground">No results found for Meghalaya yet.</p>
