// ============================================================================
// FILE: modules/Results/States/telangana/backend/index.ts
// PURPOSE: Isolated backend API for Telangana (TS) state results.
//          Queries the REAL SQLite database using Drizzle ORM.
//          Filters results where state = "Telangana".
//
...
export const stateConfig = {
  ...
  description: "Get the latest Telangana government exam results, notifications, and updates for all state-level examinations.",
  ...
  apiEndpoint: "/api/results?state=Telangana&limit=50",
} as const;
