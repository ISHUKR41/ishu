// ============================================================================
// FILE: modules/Results/States/uttarakhand/backend/index.ts
// PURPOSE: Isolated backend API for Uttarakhand (UK) state results.
//          Queries the REAL SQLite database using Drizzle ORM.
//          Filters results where state = "Uttarakhand".
//
...
export const stateConfig = {
  ...
  description: "Get the latest Uttarakhand government exam results, notifications, and updates for all state-level examinations.",
  ...
  apiEndpoint: "/api/results?state=Uttarakhand&limit=50",
} as const;
