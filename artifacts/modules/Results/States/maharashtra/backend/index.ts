// ============================================================================
// FILE: modules/Results/States/maharashtra/backend/index.ts
// PURPOSE: Isolated backend API for Maharashtra (MH) state results.
//          Queries the REAL SQLite database using Drizzle ORM.
//          Filters results where state = "Maharashtra".
//
...
export const stateConfig = {
  ...
  description: "Get the latest Maharashtra government exam results, notifications, and updates for all state-level examinations.",
  ...
  apiEndpoint: "/api/results?state=Maharashtra&limit=50",
} as const;
