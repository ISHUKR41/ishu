// ============================================================================
// FILE: modules/Resources/Categories/syllabus/frontend/index.tsx
// PURPOSE: Isolated frontend for "Syllabus" resources category.
// ============================================================================
...
export default function SyllabusResourcesPage() {
  ...
  const { data, isLoading, error } = useQuery<{ resources: ResourceItem[] }>({
    queryKey: ["resources", "category", "syllabus"],
    queryFn: async () => {
      const res = await fetch("/api/resources/category/syllabus");
        ...
        <div className="border-b border-border bg-gradient-to-b from-amber-500/5 to-background py-10">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-bold text-foreground">Syllabus</h1>
