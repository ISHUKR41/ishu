// ============================================================================
// FILE: modules/Resources/Categories/mock-tests/frontend/index.tsx
// PURPOSE: Isolated frontend for "Mock Tests" resources category.
// ============================================================================
...
export default function MocktestsResourcesPage() {
  ...
  const { data, isLoading, error } = useQuery<{ resources: ResourceItem[] }>({
    queryKey: ["resources", "category", "mock-tests"],
    queryFn: async () => {
      const res = await fetch("/api/resources/category/mock-tests");
        ...
        <div className="border-b border-border bg-gradient-to-b from-amber-500/5 to-background py-10">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-bold text-foreground">Mock Tests</h1>
