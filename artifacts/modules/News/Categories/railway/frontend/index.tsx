// ============================================================================
// FILE: modules/News/Categories/railway/frontend/index.tsx
// PURPOSE: Isolated frontend for the "Railway" news category.
//          Fetches REAL news articles filtered by category="railway"
...
/**
 * RailwayNewsPage — Dedicated page for "Railway" news articles.
 */
export default function RailwayNewsPage() {
  ...
  const { data, isLoading, error } = useQuery<{ articles: NewsArticle[]; total: number }>({
    queryKey: ["news", "category", "railway"],
    queryFn: async () => {
      const res = await fetch("/api/news/category/railway");
      if (!res.ok) throw new Error("Failed to fetch Railway news");
      return res.json();
    },
        ...
        <div className="border-b border-border bg-gradient-to-b from-purple-500/5 to-background py-10">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-bold text-foreground">Railway News</h1>
        ...
        <div className="container mx-auto px-4 md:px-6 py-10">
          {isLoading && (
            <div className="flex justify-center items-center py-20">
              ...
              <span className="ml-3 text-muted-foreground">Loading Railway news...</span>
            </div>
          )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {data.articles?.length > 0 ? (
                ...
                <div className="col-span-full text-center py-16 border border-dashed border-border rounded-2xl">
                  ...
                  <p className="text-muted-foreground">No Railway news articles yet.</p>
                </div>
              )}
            </div>
          )}
