// ============================================================================
// FILE: pages/privacy/sections/content/frontend/index.tsx
// PURPOSE: Dedicated frontend boundary wrapper for this unit.
// ============================================================================

import * as ExistingUnitModule from "../PrivacyContent";
import type { ComponentType } from "react";

/**
 * Frontend boundary wrapper for strict page-level isolation.
 */
export default function PrivacySectionsContentFrontendEntry() {
