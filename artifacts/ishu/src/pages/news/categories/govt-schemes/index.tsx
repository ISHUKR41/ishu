// FILE: artifacts/ishu/src/pages/news/categories/govt-schemes/index.tsx
...
export default function NewsGovtSchemes() {
  const { data, isLoading } = useListNews({ category: "govt-schemes", limit: 50 });
  const newsList = (data as any)?.news ?? data ?? [];

  return (
    <>
      <PageMeta
        title="Govt Schemes News - ISHU | Indian Student Hub"
        description="Latest Govt Schemes news and updates for Indian students and job seekers on ISHU platform."
        keywords="govt-schemes news, Govt Schemes updates, indian education, ishu"
        canonical={`https://ishu.in/news/category/govt-schemes`}
      />
      <div className="min-h-screen py-20">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <h1 className="text-3xl font-bold mb-2">Govt Schemes News</h1>
          <p className="text-muted-foreground mb-8">Latest Govt Schemes updates and announcements</p>
          {isLoading ? (
            ...
            <div className="text-center py-20 text-muted-foreground">
              No Govt Schemes news available yet. Check back soon.
            </div>
          )}
        </div>
      </div>
