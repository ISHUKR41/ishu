// FILE: artifacts/ishu/src/pages/news/categories/sports/index.tsx
...
export default function NewsSports() {
  const { data, isLoading } = useListNews({ category: "sports", limit: 50 });
  const newsList = (data as any)?.news ?? data ?? [];

  return (
    <>
      <PageMeta
        title="Sports News - ISHU | Indian Student Hub"
        description="Latest Sports news and updates for Indian students and job seekers on ISHU platform."
        keywords="sports news, Sports updates, indian education, ishu"
        canonical={`https://ishu.in/news/category/sports`}
      />
      <div className="min-h-screen py-20">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <p className="text-muted-foreground mb-8">Latest Sports updates and announcements</p>
          {isLoading ? (
            ...
            <div className="text-center py-20 text-muted-foreground">
              No Sports news available yet. Check back soon.
            </div>
          )}
        </div>
      </div>
